  ...
  if (!extraction) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center px-10 py-16">
        ...
        <p className="text-sm font-semibold text-slate-600 mb-1">No document analysed yet</p>
        <p className="text-xs text-slate-400">Upload a design document on the left and click Extract to begin.</p>
      </div>
    );
  }
