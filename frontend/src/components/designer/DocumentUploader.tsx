    ...
    return (
      <div className="w-full flex flex-col">
        <div className="p-5 bg-slate-50 flex flex-col gap-4">
          {!file ? (
            <div
              className="border-2 border-dashed border-slate-300 rounded-2xl bg-white flex flex-col items-center justify-center p-10 text-center hover:border-indigo-400 hover:bg-indigo-50/30 transition-colors cursor-pointer group min-h-[260px]"
            ...
            <div className="flex flex-col bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-4 flex flex-col gap-4">
                <div
                  className="min-h-[180px] flex items-center justify-center bg-slate-100 rounded-xl border border-slate-200 overflow-hidden relative cursor-pointer group"
